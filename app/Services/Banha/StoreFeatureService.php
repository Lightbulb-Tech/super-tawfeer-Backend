...
use App\Repositories\Banha\StoreFeatureRepository;

class StoreFeatureService
{
    public function __construct(private StoreFeatureRepository $repository)
    {
    ...
    {
        return $this->repository->storeFeatures($data, $store_id);
    }

    public function updateFeatures($data, $store_id)
    {
        return $this->repository->updateFeatures($data, $store_id);
    }

    public function deleteFeatures($featuresIds)
    {
        return $this->repository->deleteFeatures($featuresIds);
    }
