...
use App\Repositories\Banha\FirebaseTokenRepository;

class FirebaseTokenService
{
    public function __construct(private FirebaseTokenRepository $repository)
    {
    ...
    {
        return $this->repository->storeToken($user_id, $data);
    }
