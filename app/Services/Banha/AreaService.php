...
class AreaService
{
    public function __construct(private AreaRepository $repository, private GovernorateRepository $governorateRepository)
    {
    ...
    {
        return $this->governorateRepository->getGovernorates();
    }
