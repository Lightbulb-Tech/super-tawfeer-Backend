...
use App\Http\Requests\Banha\OrderCategoryRequest as objRequest;
...
{
    private string $folderPath = 'banha.order_categories.';
    private string $mainRoute = 'order-categories';
    ...
    public function index(Request $request, objService $service)
    {
        ...
        $data["bladeTitle"] = __("banha.order_categories");
        $data["addButtonText"] = __("banha.order_categories");
        $data["modelSize"] = 'xl';
