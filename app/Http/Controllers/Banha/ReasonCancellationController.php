...
{
    private string $folderPath = 'banha.reason_cancellation.';
    private string $mainRoute = 'reason-cancellation';
    ...
    public function index(Request $request, objService $service)
    {
        ...
        $data["bladeTitle"] = __("banha.reason_cancellation");
        $data["addButtonText"] = __("banha.reason_cancellation");
        $data["modelSize"] = 'xl';
