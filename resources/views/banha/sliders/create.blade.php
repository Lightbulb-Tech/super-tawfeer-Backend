        ...
        <div class="col-12 mb-3">
            ...
            <select class="form-control" name="type" id="type">
                ...
                @foreach($types as $type)
                    <option
                        value="{{$type->value}}">{{\App\Enums\SliderTypeisEnum::tryFrom($type->value)->lang()}}</option>
                @endforeach
            </select>
        </div>
            ...
            <div class="col-12 mb-3">
                ...
                <select class="form-control" name="module_name" id="module_name">
                    ...
                    @foreach($moduleNames as $moduleName)
                        <option
                            value="{{$moduleName->value}}">{{\App\Enums\ModulesTypeisEnum::tryFrom($moduleName->value)->lang()}}</option>
                    @endforeach
                </select>
            </div>
        </div>
