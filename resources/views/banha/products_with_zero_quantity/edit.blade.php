        ...
        @endforeach
            ...
            <select class="form-control" id="sub_categories" name="sub_category_id" data-validation="required">
                @foreach($subCategories as $subCategory)
                    <option
                        value="{{$subCategory->id}}" @selected($subCategory->id == $obj->sub_category_id)>{{$subCategory->title}}</option>
                @endforeach
            </select>
            ...
            <label for="nameBasic"
                ...
                <input type="number" class="form-control" min="1" name="amount" value="{{$obj->amount}}" id="amount"
                   data-validation="required">
        </div>
            <div class="col-3 mb-3">
            <label for="nameBasic"
            ...
            <div class="col-3 mb-3">
                ...
                <input type="number" class="form-control" min="1" name="max_quantity_for_order"
                       id="max_quantity_for_order"
                       value="{{$obj->max_quantity_for_order}}"
                       data-validation="required">
            </div>
            <div class="col-4 mb-3">
