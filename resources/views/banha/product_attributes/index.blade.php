    ...
    <div class="card p-3">
        <div class="card-datatable table-responsive pt-0">
            <table id="dataTable" class="datatables-basic table">
                ...
                <tr>
                    <th>#</th>
                    <th>{{__('banha.attribute_name')}}</th>
                    <th>{{__('banha.attribute_value')}}</th>
        ...
        $(function () {
            myTable = $('#dataTable').DataTable({
                ...
                columns: [
                    ...
                    {"data": 'attribute_name', name: 'attribute_name', orderable: false, searchable: true},
                    {"data": 'attribute_value', name: 'attribute_value', orderable: false, searchable: true},
